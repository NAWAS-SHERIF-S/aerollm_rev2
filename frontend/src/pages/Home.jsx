...
import { ChevronRight, Database, Cpu, ShieldCheck, LineChart, ArrowRight, Sparkles, Activity } from 'lucide-react';
    ...
    <div className="space-y-16 pb-12">
      ...
      <section className="relative min-h-[88vh] flex items-center justify-center pt-6 overflow-hidden rounded-3xl border border-white/15 bg-gradient-to-b from-[#0b1433]/80 via-[#070b19]/90 to-[#070b19]">
        ...
        <div className="absolute inset-0 z-0 overflow-hidden">
          ...
          />
          {/* Transparent Vignette Overlay for Text Legibility while Keeping Aeroplane Bright */}
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-12 py-12 w-full grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            <div className="flex flex-wrap items-center gap-4 pt-2">
              <button 
                ...
                className="btn-primary-pill text-base py-3.5 px-8"
              >
              ...
              <button 
                ...
                className="btn-secondary-glass text-base py-3.5 px-8"
              >
          ...
          {/* Right Floating Glass HUD Panels (Overlaying Crisp Jetliner Visual) */}
          <div className="lg:col-span-5 relative min-h-[400px] hidden lg:block">
            
            {/* HUD Panel 1: Global Aviation Insights */}
            ...
            {/* HUD Label 2: From Data to Safer Skies */}
            ...
            {/* HUD Label 3: AI for a Safer Tomorrow */}
