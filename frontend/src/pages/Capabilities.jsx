    ...
    <div className="max-w-7xl mx-auto px-4 lg:px-8 py-8 space-y-16">
      ...
      <div className="glass-panel p-8 md:p-12 relative overflow-hidden border border-cyan-500/30 bg-gradient-to-r from-[#0b122c] via-[#0f1b40] to-[#070b19]">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          ...
          <div className="lg:col-span-7 space-y-5">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 pt-2">
              <div className="p-3.5 rounded-xl bg-white/5 border border-white/10">
                <p className="text-xs text-slate-400">Base Architecture</p>
                <p className="text-sm font-bold text-white font-mono mt-0.5">Qwen2.5-7B</p>
              </div>
              <div className="p-3.5 rounded-xl bg-white/5 border border-white/10">
                <p className="text-xs text-slate-400">Extraction Precision</p>
                <p className="text-sm font-bold text-cyan-400 font-mono mt-0.5">99.2% ATA Code</p>
              </div>
              <div className="p-3.5 rounded-xl bg-white/5 border border-white/10">
                <p className="text-xs text-slate-400">Context Window</p>
            ...
            <div className="pt-2">
              <button
                onClick={() => setActivePage('try')}
                className="btn-primary-pill py-3 px-7 text-sm"
              >
          ...
          <div className="lg:col-span-5 p-6 rounded-2xl bg-black/40 border border-white/10 font-mono text-xs text-slate-300 space-y-3">
            ...
            <p className="text-slate-400">Input: "VT101 low hydraulic pressure on taxi."</p>
            <div className="p-3 rounded-lg bg-cyan-950/40 border border-cyan-500/30 text-cyan-300 space-y-1">
              <p>{"{"}</p>
